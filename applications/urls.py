...
urlpatterns = [
    # Student
    path('<uuid:listing_id>/apply/', HostelApplicationCreateView.as_view(), name='hostel-apply'),
    path('my-applications/', MyApplicationsView.as_view(), name='my-applications'),
    path('my-applications/<uuid:pk>/', MyApplicationDetailView.as_view(), name='my-application-detail'),

    # Seller
    path('listings/<slug:slug>/', ListingApplicationListView.as_view(), name='listing-applications'),
